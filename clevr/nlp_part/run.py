...
from dataset import ClevrQuestionS2SDataset
...
def main():
    global PAD_IDX, BOS_IDX, EOS_IDX, text_transform, SRC_LANGUAGE, TGT_LANGUAGE, loss_fn, vocab_transform
    vocab_transform, SRC_LANGUAGE, TGT_LANGUAGE, PAD_IDX, token_transform = prepare_data()
    ...
    for epoch in tqdm(range(1, NUM_EPOCHS + 1), desc="epoch"):
        ...
        logger.info("Translate to: "+ translate(transformer, "Ein Schwarm Enten auf dem Eis."))

    logger.info("Final to: "+ translate(transformer, "Ein Schwarm Enten auf dem Eis."))
